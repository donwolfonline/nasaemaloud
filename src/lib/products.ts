...
export const products: Product[] = [
    ...
    { id: "46", category: "مسك", name: "مسك رمان (صغير)", price: 15 },
    { id: "47", category: "مسك", name: "مسك رمان (وسط)", price: 25 },
    { id: "48", category: "مسك", name: "مسك رمان (كبير)", price: 30 },
    { id: "49", category: "مسك", name: "مسك بودرة (صغير)", price: 15 },
    { id: "50", category: "مسك", name: "مسك بودرة (وسط)", price: 25 },
    { id: "51", category: "مسك", name: "مسك بودرة (كبير)", price: 30 },
    { id: "52", category: "مسك", name: "مسك صبايا (صغير)", price: 15 },
    { id: "53", category: "مسك", name: "مسك صبايا (وسط)", price: 25 },
    { id: "54", category: "مسك", name: "مسك صبايا (كبير)", price: 30 },
    { id: "55", category: "مسك", name: "مسك شنزليزية (صغير)", price: 15 },
    { id: "56", category: "مسك", name: "مسك شنزليزية (وسط)", price: 25 },
    { id: "57", category: "مسك", name: "مسك شنزليزية (كبير)", price: 30 },
    { id: "58", category: "مسك", name: "مسك لافندر (صغير)", price: 15 },
    { id: "59", category: "مسك", name: "مسك لافندر (وسط)", price: 25 },
    { id: "60", category: "مسك", name: "مسك لافندر (كبير)", price: 30 },
